...
class Palette {
  static final Color primaryColor = Color(0xFF0cc170);
  static const Color primaryConstant = Color(0xFF0cc170);
  static final Color blueColor = Color(0xff0cc170);
  ...
  static final Color onlineDotColor = Color(0xff0cc170);
  static final Color lightBlueColor = Color(0xff0048d7);
  static final Color separatorColor = Color(0xff272c35);

  static final Color gradientColorStart = Color(0xff0cc170);
  ...
  static const Color darkBlue = Color(0xFF0cc170);
