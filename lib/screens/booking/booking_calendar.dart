...
class EventCalendarState extends State<EventCalendar> {
  ...
  List<Meeting> getMeetingDetails() {
    ...
    eventNameCollection.add('Nakuru charge');
    eventNameCollection.add('Hike charge point1');
    eventNameCollection.add('Travel charge plan');
    eventNameCollection.add('Travel charge plan1');
    eventNameCollection.add('Travel charge plan2');
    eventNameCollection.add('Travel charge plan3');
    eventNameCollection.add('Travel charge plan4');
    eventNameCollection.add('Travel charge plan5');
    eventNameCollection.add('Travel charge plan6');
    eventNameCollection.add('Travel charge plan7');
